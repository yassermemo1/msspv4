...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 flex-shrink-0 pt-4 border-t border-gray-200 mt-auto",
      className
    )}
    {...props}
  />
...
// New scrollable body component for forms and long content
const DialogBody = ({
  className,
  ...props
}: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      "flex-1 overflow-y-auto min-h-0 px-1 -mx-1",
      className
    )}
    {...props}
  />
