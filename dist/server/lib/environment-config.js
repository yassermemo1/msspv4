...
class EnvironmentConfigManager {
    ...
    loadConfig() {
        ...
        this.config = {
            ...
            testing: {
                ...
                credentials: isDevelopment ? test_data_generator_1.testDataGenerator.getTestCredentials() : null,
    ...
    getDatabaseUrl() {
        ...
        return test_data_generator_1.testDataGenerator.generateSecureDatabaseUrl();
    }
    getSessionSecret() {
        ...
        return test_data_generator_1.testDataGenerator.generateSecurePassword(64);
    }
    parseCorsOrigins() {
    ...
    logConfigSummary() {
        ...
        if (config.testing.enabled && config.server.environment === 'development') {
            test_data_generator_1.testDataGenerator.logTestCredentials();
        }
    }
    /**
...
exports.environmentConfig = EnvironmentConfigManager.getInstance();
