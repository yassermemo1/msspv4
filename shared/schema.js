...
exports.clientsRelations = (0, drizzle_orm_1.relations)(exports.clients, ({ many }) => ({
    ...
    transactions: many(exports.financialTransactions, { relationName: "clientTransactions" }),
...
exports.contractsRelations = (0, drizzle_orm_1.relations)(exports.contracts, ({ one, many }) => ({
    ...
    transactions: many(exports.financialTransactions, { relationName: "contractTransactions" }),
}));
...
exports.serviceScopesRelations = (0, drizzle_orm_1.relations)(exports.serviceScopes, ({ one, many }) => ({
    ...
    licenses: many(exports.clientLicenses),
    hardwareAssignments: many(exports.clientHardwareAssignments),
    transactions: many(exports.financialTransactions, { relationName: "scopeTransactions" }),
}));
...
exports.licensePoolsRelations = (0, drizzle_orm_1.relations)(exports.licensePools, ({ many }) => ({
    ...
    transactions: many(exports.financialTransactions, { relationName: "poolTransactions" }),
}));
...
exports.hardwareAssetsRelations = (0, drizzle_orm_1.relations)(exports.hardwareAssets, ({ many }) => ({
    ...
    transactions: many(exports.financialTransactions, { relationName: "assetTransactions" }),
}));
...
exports.financialTransactionsRelations = (0, drizzle_orm_1.relations)(exports.financialTransactions, ({ one }) => ({
    client: one(exports.clients, {
        fields: [exports.financialTransactions.clientId],
        references: [exports.clients.id],
        relationName: "clientTransactions"
    }),
    contract: one(exports.contracts, {
        fields: [exports.financialTransactions.contractId],
        references: [exports.contracts.id],
        relationName: "contractTransactions"
    }),
    serviceScope: one(exports.serviceScopes, {
        fields: [exports.financialTransactions.serviceScopeId],
        references: [exports.serviceScopes.id],
        relationName: "scopeTransactions"
    }),
    licensePool: one(exports.licensePools, {
        fields: [exports.financialTransactions.licensePoolId],
        references: [exports.licensePools.id],
        relationName: "poolTransactions"
    }),
    hardwareAsset: one(exports.hardwareAssets, {
        fields: [exports.financialTransactions.hardwareAssetId],
        references: [exports.hardwareAssets.id],
...
exports.customWidgets = (0, pg_core_1.pgTable)("custom_widgets", {
    ...
    groupBy: (0, pg_core_1.jsonb)("group_by"), // Group by configuration for charts and data processing
    isActive: (0, pg_core_1.boolean)("is_active").notNull().default(true),
    createdAt: (0, pg_core_1.timestamp)("created_at").notNull().defaultNow(),
    updatedAt: (0, pg_core_1.timestamp)("updated_at").notNull().defaultNow(),
}, (table) => [
